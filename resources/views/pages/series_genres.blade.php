...
<section class="movies padding-x section-padding-y">
    ...
    <h2 class="section__title">{{trans('words.tv_show_genres')}}</h2>

    <ul class="show__list py-2">
        @foreach($genres_list as $genres_data)
        <li class="show__item">
            <a href="{{ URL::to('genres/series/'.$genres_data->genre_slug) }}" class="show__link"></a>
            ...
            <a href="{{ URL::to('genres/series/'.$genres_data->genre_slug) }}" class="play__btn">
