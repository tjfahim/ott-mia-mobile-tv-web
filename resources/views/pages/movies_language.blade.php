...
<section class="movies padding-x section-padding-y">
    ...
    <h2 class="section__title">{{trans('words.movies_lang')}}</h2>

    <ul class="show__list py-2">
        @foreach($lang_list as $lang_data)
        <li class="show__item">
            <a href="{{ URL::to('language/movies/'.$lang_data->language_slug) }}" class="show__link"></a>
            ...
            <a href="{{ URL::to('language/movies/'.$lang_data->language_slug) }}" class="play__btn">
