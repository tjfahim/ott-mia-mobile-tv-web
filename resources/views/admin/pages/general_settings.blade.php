                ...
                @endif
                 ...
                 {!! Form::open(array('url' => array('admin/general_settings'),'class'=>'form-horizontal','name'=>'settings_form','id'=>'settings_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                  ...
                  <div class="form-group row" id="omdbapi_id">
                    ...
                    <div class="col-sm-8">
                      <textarea name="broadcast_link" class="form-control">{{ isset($settings->broadcast_link) ? stripslashes($settings->broadcast_link) : null }}</textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="footer_linkdin_link" value="{{ isset($settings->footer_linkdin_link) ? stripslashes($settings->footer_linkdin_link) : null }}" class="form-control">
                    </div>
                  </div>
                  {{-- <div class="form-group row">
