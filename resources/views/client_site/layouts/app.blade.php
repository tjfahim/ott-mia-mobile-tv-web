...
<body class="font-manrope text-white relative"  x-data="{loginform: false, regform: false}">
                ...
                <div class="flex justify-between gap-3">
                    <div class="hidden sm:flex gap-1">
                        <div class="relative" x-data="{open: false}" @click.away="open = false">
                            <button @click="open = !open" class="p-3 bg-second_black rounded-full hover:scale-110 duration-300"><img src="{{ URL::asset('frontend/images/search-icon.svg')}}" alt=""></button>
                            <div
                                x-show="open"
                                ...
                                <form action="relative">
                                    ...
                                    <button class="absolute top-1/2 trasnform -translate-y-1/2 hover:scale-95 duration-300 right-2"><img src="{{ URL::asset('frontend/images/search-icon.svg')}} " alt=""></button>
                                </form>
                            </div>
                        </div>
                        <button class="p-3 bg-second_black rounded-full hover:scale-110 duration-300"><img src="{{ URL::asset('frontend/images/notif-icon.svg') }}" alt=""></button>
                    </div>
                    <div class="flex justify-center gap-3 sm:items-center">
                        ...
                        @auth
                            <div class="group flex gap-3 items-center cursor-pointer px-3 py-2 rounded-full bg-first_black ">
                                <img class="size-8 group-hover:scale-110 duration-300 transform " src="{{ URL::asset('frontend/images/user.png')}}" alt="">
                                <div>User</div>

                                <div class="relative " x-data="{open: false}" @click.away="open = false">
                                    <button @click="open = !open" class="bg-second_black rounded-full p-2 hover:scale-110 duration-300 transform ease-in"><img class="size-4" src="{{  URL::asset('frontend/images/3dot.svg') }}" alt=""></button>
                                    ...
                                    <div
                                        ...
                                        <a href="" class="py-2 px-3 text-md hover:scale-105 duration-300 ease-out text-redcolor">Logout</a>
                                    </div>
                                </div>
                            </div>
                        @endauth
    ...
    <div class="bg-first_black w-full ">
     ...
     <!-- login section start -->
    <div class="popup-login bg-first_black rounded-md  p-10 absolute top-[120px] left-1/2 transform -translate-x-1/2" x-show="loginform" @click.away="loginform = false">
            ...
            <form action="{{ URL::to('login') }}" class="flex gap-5 flex-col" method="post">
                ...
                <div class="border border-[#FFFFFF1A]  hover:border-[#ED2024] rounded-md p-3   gap-3 flex items-center justify-start" >
                    ...
                    <div class="flex-1 flex-col gap-2 text-[#FFFFFF66]">
                        ...
                        @error('email')
                            <small class="text-sm text-redColor
                            ">{{ $message }}</small>
                        @enderror
                    </div>
                    <div>
    ...
    <!-- registation start  -->
    <div class="popup-register bg-first_black rounded-md  p-10 absolute top-[120px] left-1/2 transform -translate-x-1/2" x-show="regform" @click.away="regform = false">
    <section class=" ">
        <div class="text-center text-white space-y-5">
        ...
        <button @click="regform = false" class="close-popup absolute top-3 right-3 p-3 hover:scale-90 duration-300 rounded-full bg-redcolor"><img src="{{ URL::asset('frontend/images/x.svg') }}" alt=""></button>
    </section>
    </div>
    <!-- registation end  -->
