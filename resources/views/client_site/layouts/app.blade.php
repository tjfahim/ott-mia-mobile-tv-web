    ...
    <div x-cloak class="popup-login bg-first_black rounded-md p-4 sm:p-10 absolute left-5 right-5 top-20 w-full lg:w-1/3  md:top-[120px] md:left-1/2 md:transform md:-translate-x-1/2" x-show="loginform"
        ...
        <section class="p-3 sm:p-10 w-full">
            ...
            <div class="flex gap-4 opacity-70 pt-10 justify-center">
                <a class="hover:scale-110 duration-300 hover:border bg-transparent opacity-90 p-2 rounded" href="{{ route('login.facebook') }}">
                    <img style="height: 24px; width: 24px;" src="{{  URL::asset('frontend/images/facebook-Icon.svg') }}" alt="">
                </a>
                <a class="hover:scale-110 duration-300 hover:border bg-transparent opacity-90 p-2 rounded" href="{{  route('login.google') }}">
                    <img style="height: 24px; width: 24px;" src="{{  URL::asset('frontend/images/x-Icon.svg') }}" alt="">
                </a>
                {{-- <a class="hover:scale-110 duration-300 hover:border bg-transparent opacity-90 p-2 rounded" href="">
                    <img style="height: 24px; width: 24px;" src="{{  URL::asset('frontend/images/linkdin-icon.svg') }}" alt="">
                </a> --}}
            </div>
        </section>
