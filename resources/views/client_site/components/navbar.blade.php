<nav class="flex flex-col  sm:flex-row justify-between sm:items-center p-5 gap-5 h-[90px]">
    ...
    <div class="hidden sm:flex flex-col sm:flex-row p-1.5  sm:bg-first_black sm:rounded-full text-white font-manrope ">
                ...
                <div class="group flex gap-3 items-center cursor-pointer px-3 py-2 rounded-full bg-first_black ">
                    ...
                    <div class="relative " x-data="{open: false}" @click.away="open = false">
                        ...
                        <div
                            ...
                            <a href="{{ URL::to('account/info') }}" class="py-2 px-3 text-md hover:scale-105 duration-300 ease-out">Account</a>
                            ...
                            <a href="{{ URL::to('favorite') }}" class="py-2 px-3 text-md hover:scale-105 duration-300 ease-out ">Favorites</a>
                            <a href="{{ URL::to('logout') }}" class="py-2 px-3 text-md hover:scale-105 duration-300 ease-out text-redcolor">Logout</a>
                        </div>
                    </div>
                </div>
            @endauth
