...
<head>
  ...
  <!-- Bootstrap CSS -->
  <link rel="stylesheet" href="{{ URL::asset('site_assets/assets/libraries/bootstrap/css/bootstrap.min.css')}}" />

  <!-- Splide CSS -->
  <link rel="stylesheet" href="{{ URL::asset('site_assets/assets/libraries/splide/css/splide.min.css')}}" />

  <!-- Font Awesome CSS -->
  <link rel="stylesheet" href="{{ URL::asset('site_assets/assets/libraries/fontawesome/css/all.min.css')}}" />
...
<body>
  ...
  <!-- Bootstrap Bundle JS -->
  <script src="{{ URL::asset('site_assets/assets/libraries/bootstrap/js/bootstrap.bundle.min.js')}}"></script>

  <!-- Splide JS -->
  <script src="{{ URL::asset('site_assets/assets/libraries/splide/js/splide.min.js')}}"></script>

  <!-- Vanilla Emoji Picker -->
  <script src="{{ URL::asset('site_assets/assets/libraries/vanilla-javascript-emoji-picker/vanillaEmojiPicker.js')}}"></script>

  <!-- External JS -->
  <script src="{{ URL::asset('site_assets/js/index.js')}}"></script>
  <script src="{{ URL::asset('site_assets/js/homeSliders.js')}}"></script>
  <script src="{{ URL::asset('site_assets/js/home.js')}}"></script>
  <script src="{{ URL::asset('site_assets/js/single-page.js')}}"></script>
