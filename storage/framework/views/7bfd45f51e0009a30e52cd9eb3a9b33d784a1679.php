...
<section class="movies padding-x section-padding-y">
    ...
    <h2 class="section__title"><?php echo e(trans('words.movies_genres')); ?></h2>
    ...
    <ul class="show__list py-2">
        ...
        <li class="show__item">
            <a href="<?php echo e(URL::to('genres/movies/'.$genres_data->genre_slug)); ?>" class="show__link"></a>
            ...
            <a href="<?php echo e(URL::to('genres/movies/'.$genres_data->genre_slug)); ?>" class="play__btn">
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/netskytv/public_html/resources/views/pages/movies_genres.blade.php ENDPATH**/ ?>