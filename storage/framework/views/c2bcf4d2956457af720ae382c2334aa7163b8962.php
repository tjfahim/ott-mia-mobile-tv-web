...
<body>
    <div class="" style="background-image:  linear-gradient(0deg, rgba(16,8,8,0.6587009803921569) 7%, rgba(8,8,8,0.07046568627450978) 100%), url(<?php echo e(URL::asset('assets/frontend/images/SubContainer.png')); ?>)">
        <!--  nav section start -->
        <div class="container mx-auto ">
            ...
            <section class="flex justify-center align-center p-10">
                    ...
                    <img src="<?php echo e(URL::asset('assets/frontend/images/Hero-logo.png')); ?>" alt="">
             ...
             <section class="py-10 flex justify-center">
                <div class="flex flex-col items-center justify-between gap-4 px-5 text-center  sm:w-1/3 ">
                    ...
                    <a href="" class="btn-red hover:opacity-50 flex items-center">
                        <img src="<?php echo e(URL::asset('assets/frontend/images/play-Icon.svg')); ?>" alt="">
                        Start Watching Now
                    </a>
                </div>
             </section>
...
<?php /**PATH C:\xampp\htdocs\hadiuzzaman2\ott-mia-mobile-tv-web\resources\views/frontend/layouts/IndexLayout.blade.php ENDPATH**/ ?>