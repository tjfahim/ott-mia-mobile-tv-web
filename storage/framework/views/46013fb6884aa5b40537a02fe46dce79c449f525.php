            ...
            <div class="col-lg-12">
              <div class="card-box">
                ...
                <div class="row">
                 ...
                 <div class="col-md-6"> 
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="app_name" value="<?php echo e(isset($settings->app_name) ? stripslashes($settings->app_name) : null); ?>" class="form-control">
                    </div>
                  </div>
                ...
                <div class="col-md-6">
                    ...
                    <label class="col-sm-3 col-form-label">Banner Ad Type</label>
                      <div class="col-sm-8">
                            <select class="form-control" name="banner_ad_type" id="banner_ad_type">                               
                                <option value="Admob" <?php if(isset($settings->banner_ad_type) AND $settings->banner_ad_type=='Admob'): ?> selected <?php endif; ?>>Admob</option>
                                <option value="Facebook" <?php if(isset($settings->banner_ad_type) AND $settings->banner_ad_type=='Facebook'): ?> selected <?php endif; ?>>Facebook</option>                            
                            </select>
                      </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row" id="admob_banner_id" <?php if($settings->banner_ad_type!="Admob"): ?> style="display:none;" <?php endif; ?>>
                  ...
                  <div class="form-group row" id="fb_banner_id" <?php if($settings->banner_ad_type!="Facebook"): ?> style="display:none;" <?php endif; ?>>
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.android_banner_id')); ?></label>
                    <div class="col-sm-8">
                      <input type="text" name="fb_banner_id" value="<?php echo e(isset($settings->fb_banner_id) ? $settings->fb_banner_id : null); ?>" class="form-control">
                    </div>
                  </div>
                    ...
                    <label class="col-sm-3 col-form-label">Interstitial Ad Type</label>
                      <div class="col-sm-8">
                            <select class="form-control" name="interstitial_ad_type" id="interstitial_ad_type">                               
                                <option value="Admob" <?php if(isset($settings->interstitial_ad_type) AND $settings->interstitial_ad_type=='Admob'): ?> selected <?php endif; ?>>Admob</option>
                                <option value="Facebook" <?php if(isset($settings->interstitial_ad_type) AND $settings->interstitial_ad_type=='Facebook'): ?> selected <?php endif; ?>>Facebook</option>                            
                            </select>
                      </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row" id="admob_interstitial_id" <?php if($settings->interstitial_ad_type!="Admob"): ?> style="display:none;" <?php endif; ?>>
                  ...
                  <div class="form-group row" id="fb1_interstitial_id" <?php if($settings->interstitial_ad_type!="Facebook"): ?> style="display:none;" <?php endif; ?>>
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.android_interstitial_id')); ?></label>
                    <div class="col-sm-8">
                      <input type="text" name="fb_interstitial_id" value="<?php echo e(isset($settings->fb_interstitial_id) ? $settings->fb_interstitial_id : null); ?>" class="form-control">
                    </div>
                  </div>
                  <div class="form-group row">
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hadiuzzaman2\ott-mia-mobile-tv-web\resources\views/admin/pages/android_settings.blade.php ENDPATH**/ ?>