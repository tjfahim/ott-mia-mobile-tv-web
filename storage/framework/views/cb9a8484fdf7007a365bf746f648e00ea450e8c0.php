                    ...
                    <div class="panel panel-default credit-card-box">
                        ...
                        <div class="panel-body">
                            ...
                            <form role="form" action="/stripe" method="post" class="require-validation bg-transparent"
                                data-cc-on-file="false" data-stripe-publishable-key="<?php echo e($setting->stripe_publishable_key); ?>"
                                id="payment-form">
                                <?php echo csrf_field(); ?>
                                ...
                                <?php if(Session::has('error')): ?>
                                    <div class='form-row row'>
                                        <div class='col-md-12 error form-group hide'>
                                            <div class='alert-danger alert'><?php echo e(Session::get('error')); ?></div>
                                        </div>
                                    </div>
                                <?php endif; ?>
                                <div class="row text-center">
                                    <div class="col-xs-12">
                                        <button class="btn btn-danger btn-lg btn-block" type="submit">Pay Now
                                            ($<?php echo e($plan_info->plan_price); ?>)</button>
                                    </div>
                                </div>
        ...
        $(function() {
            ...
            function stripeResponseHandler(status, response) {
                if (response.error) {
                    ...
                    $form.append("<input type='hidden' name='amount' value='" + <?php echo e($plan_info->plan_price); ?> +
                        "'/>");
                    $form.get(0).submit();
                }
            }
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/netskytv/public_html/resources/views/pages/paywithstripe.blade.php ENDPATH**/ ?>