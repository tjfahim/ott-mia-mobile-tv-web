              ...
              <div class="card-box">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group row" id="live_embed_id" <?php if(isset($tv_info->channel_url_type) AND $tv_info->channel_url_type!="embed"): ?> style="display:none;" <?php endif; ?> <?php if(!isset($tv_info->channel_url_type)): ?> style="display:none;" <?php endif; ?>>
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.tv_embed_code')); ?>*</label>
                     <div class="col-sm-8">
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/netskytv/public_html/resources/views/admin/pages/addeditlivetv.blade.php ENDPATH**/ ?>