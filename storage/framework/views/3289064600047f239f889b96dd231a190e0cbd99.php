                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav__one" role="tabpanel" aria-labelledby="nav__one__tab">
                        ...
                        <div class="forgot__pass__link">
                            <a href="<?php echo e(URL::to('password/email')); ?>" class="forgot__password"><?php echo e(trans('words.forgot_password')); ?></a>
                        </div>
                        <?php echo Form::close(); ?>
