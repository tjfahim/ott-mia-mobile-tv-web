...
<div class="main-slider container mx-auto py-10">
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
     ...
     <div class="border border-second_black p-10 " >
        ...
        <!-- Netflix shows cart start -->
        <section class="py-[50px]">
           <div class="flex justify-between items-center text-white mb-10">
               <h2 class="text-3xl font-bold ">Netflix shows</h2>
               <a href="<?php echo e(URL::to('vod/shows/all?&categorie=Netflix shows')); ?> " class="text-xl text-[#ED2024] hover:underline hover:underline-offset-4">View All</a>
           </div>
           <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 gap-[50px]">

                <?php $__currentLoopData = $Netflix_shows_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $show): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(URL::to('show/'.$show->series_slug)); ?> ">
                        <div class="border border-third_black bg-first_black min-h-[350px] flex flex-col justify-between p-3 rounded-md space-y-5">
                            <img class="w-full h-[300px] rounded-md" src="<?php echo e(URL::to( 'upload/source/'.$show->series_poster )); ?>" alt="">
                            <div class="text-white flex justify-between items-center text-sm">
                                <button class="flex justify-center items-center gap-1 text-sm border border-third_black rounded-full px-2 py-1 bg-second_black"><img src="./images/time-icon.png" alt=""><span><?php echo e($show->duration); ?></span></button>
       ...
       <!-- Netflix shows card end -->

       <!-- 4K Netflix shows card start -->
       <section class="py-[50px]">
           <div class="flex justify-between items-center text-white mb-10">
               <h2 class="text-3xl font-bold ">4K Netflix shows</h2>
               <a href="<?php echo e(URL::to('vod/shows/all?categorie=4K Netflix shows')); ?> " class="text-xl text-[#ED2024] hover:underline hover:underline-offset-4">View All</a>
           </div>
           <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 gap-[50px]">
                <?php $__currentLoopData = $_4k_netflix_shows_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $show): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(URL::to('show/'.$show->series_slug)); ?> ">
                        <div class="border border-third_black bg-first_black min-h-[350px] flex flex-col justify-between p-3 rounded-md space-y-5">
                            <img class="w-full h-[300px] rounded-md" src="<?php echo e(URL::to( 'upload/source/'.$show->series_poster )); ?>" alt="">
                            <div class="text-white flex justify-between items-center text-sm">
       ...
       <section class="py-[50px]">
           <div class="flex justify-between items-center text-white mb-10">
               ...
               <a href="<?php echo e(URL::to('vod/shows/all?&categorie=Disney Kids')); ?> " class="text-xl text-[#ED2024] hover:underline hover:underline-offset-4">View All</a>
           </div>
           <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 gap-[50px]">
                <?php $__currentLoopData = $Disney_Kids_shows_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $show): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(URL::to('show/'.$show->series_slug)); ?> ">
                        <div class="border border-third_black bg-first_black min-h-[350px] flex flex-col justify-between p-3 rounded-md space-y-5">
                            <img class="w-full h-[300px] rounded-md" src="<?php echo e(URL::to( 'upload/source/'.$show->series_poster )); ?>" alt="">
                            <div class="text-white flex justify-between items-center text-sm">
       ...
       <!-- Disney+ shows card end -->

       <!-- [EN] Gangster & Mafia  card start -->
       <section class="py-[50px]">
           <div class="flex justify-between items-center text-white mb-10">
               <h2 class="text-3xl font-bold ">[EN] Gangster & Mafia </h2>
               <a href="<?php echo e(URL::to('vod/shows/all?&categorie=GangsterAndMafia')); ?> " class="text-xl text-[#ED2024] hover:underline hover:underline-offset-4">View All</a>
           </div>
           <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 gap-[50px]">

                <?php $__currentLoopData = $Gangster_Mafia_shows_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $show): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(URL::to('show/'.$show->series_slug)); ?> ">
                        <div class="border border-third_black bg-first_black min-h-[350px] flex flex-col justify-between p-3 rounded-md space-y-5">
                            <img class="w-full h-[300px] rounded-md" src="<?php echo e(URL::to( 'upload/source/'.$show->series_poster )); ?>" alt="">
                            <div class="text-white flex justify-between items-center text-sm">
       ...
       <!-- Apple+ shows  card start -->
       <section class="py-[50px]">
           <div class="flex justify-between items-center text-white mb-10">
               <h2 class="text-3xl font-bold ">Apple+ shows </h2>
               <a href="<?php echo e(URL::to('vod/shows/all?&categorie=Apple shows')); ?> " class="text-xl text-[#ED2024] hover:underline hover:underline-offset-4">View All</a>
           </div>
           <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 gap-[50px]">
                <?php $__currentLoopData = $Apple_shows_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $show): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(URL::to('show/'.$show->series_slug)); ?> ">
                        <div class="border border-third_black bg-first_black min-h-[350px] flex flex-col justify-between p-3 rounded-md space-y-5">
                            <img class="w-full h-[300px] rounded-md" src="<?php echo e(URL::to( 'upload/source/'.$show->series_poster )); ?>" alt="">
                            <div class="text-white flex justify-between items-center text-sm">
...
<?php echo $__env->make('client_site.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hadiuzzaman2\ott-mia-mobile-tv-web\resources\views/frontend/vod/shows.blade.php ENDPATH**/ ?>