        ...
        <div class="nav-links">
            ...
            <ul>
                ...
                <?php for($i = 1; $i <= $paginator->lastPage(); $i++): ?>
                    ...
                    ?>
                    <?php if($from < $i && $i < $to): ?> <li class="<?php echo e(($paginator->currentPage() == $i) ? ' current' : ''); ?>">
...
<?php endif; ?><?php /**PATH /home/netskytv/public_html/resources/views/_particles/pagination.blade.php ENDPATH**/ ?>