      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card-box">
            ...
            <form action="<?php echo e(URL::to('admin/categories')); ?>" method="POST" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hadiuzzaman2\ott-mia-mobile-tv-web\resources\views/admin/pages/categories/create.blade.php ENDPATH**/ ?>