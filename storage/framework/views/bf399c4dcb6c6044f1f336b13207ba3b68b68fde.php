        ...
        <div class="flex flex-col h-full">
            ...
            <div x-data="{
                ...
                async submit(){
                    ...
                    axios.post('<?php echo e(URL::to('contact')); ?>', this.form ,{
                        headers: {
                            'X-CSRF-TOKEN': this.csrfToken,
                            'Content-Type': 'application/json',
                            'Accept': 'application/json'
...
<?php /**PATH C:\xampp\htdocs\hadiuzzaman2\december\ott-mia-web-laravel\resources\views/client_site/layouts/app.blade.php ENDPATH**/ ?>