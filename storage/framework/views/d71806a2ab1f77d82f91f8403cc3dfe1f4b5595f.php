...
<!-- hero section start -->
<div class="p-5  xl:h-[calc(100vh-90px)]"
style="background: linear-gradient(to bottom, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.5) 100%), linear-gradient(to top, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.5) 100%), url('<?php echo e(URL::asset('frontend/images/bg-hero.png')); ?>'); background-size: cover; background-position: center;">
    <div class="h-full w-3/4 mx-auto flex flex-col gap-5 justify-center items-center">
        <img class="w-[350px] md:w-[450px]" src="<?php echo e(URL::asset('frontend/images/logo-hero.svg')); ?>" alt="">
...
<div class="bg-black">
    <div class="container mx-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 grid-flow-row md:grid-cols-3 gap-10 p-10 sm:p-0">
                <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="rounded-md flex flex-col  gap-4 justify-between p-5 " style="background: linear-gradient(to bottom, rgba(26, 26, 26, 1) 0%, rgba(26, 26, 26, 1) 100%);">
                        <img class="w-full min-h-[300px] rounded-md" src="<?php echo e(URL::to('upload/source/'.$cat->image)); ?>" alt="" style="background: linear-gradient(to bottom, rgba(26, 26, 26, 1) 0%, rgba(26, 26, 26, 1) 100%);">
        ...
        <section class="space-y-10 py-20 px-10 md:px-0">
...
background: linear-gradient(59deg, rgba(16,8,8,0.9136029411764706) 31%, rgba(8,8,8,0.7679446778711485) 69%, rgba(241,4,4,0.21332282913165268) 100%);">
        ...
        <!-- tv statation end -->
            ...
            <section class="space-y-10 p-10 sm:px-0   sm:py-20">
                        ...
                        <div>
                            <div class="flex justify-between items-start gap-2 question bg-black pb-5 border-b border-transparent" x-data="{open: false}" @click.outside="open=false">
                                ...
                                <div class="text-white answer flex flex-col items-start justify-center flex-1">
                                    <div :class="open ? 'mb-2' : 'mb-2 mt-2'" ><?php echo e($faq->title); ?></div>
        ...
        <section class="space-y-10 py-[100px]">
            ...
            <!-- monthly plan -->
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-10 p-10 sm:p-0 min-h-[300px]" id="monthly_plan">
                ...
                <?php $__currentLoopData = $monthly_plan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-second_black p-5 flex flex-col text-white gap-5 rounded w-full ">
                       ...
                       ?>
                       <p class="opacity-50 flex-1"><?php echo e($des); ?></p>
                        <div class="">
            ...
            <!-- yearly plan -->
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-10 p-10 sm:p-0 min-h-[300px]" id="yearly_plan">
        ...
        <section class="px-10 sm:px-0 rounded  min-h-[250px] flex  justify-center items-center" ; >
            <div class="flex flex-col sm:flex-row justify-between gap-10 items-center w-full p-10 py-20 " style="background-image: url(<?php echo e(URL::asset('frontend/images/BackgroundImages.png')); ?>) ">
    ...
    <div class="container mx-auto">
        ...
        <section class="py-10 space-y-5 p-10">
            ...
            <div class="slider1">
                ...
                <div class="min-h-[300px] w-[200px] mx-5 flex flex-col justify-between">
            ...
            <div class="slider1">
                ...
                <?php $__currentLoopData = $movies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(URL::to('movie/'.$movie->video_slug)); ?> ">
                        <div class="min-h-[300px] w-[200px] mx-5 flex flex-col justify-between hover:scale-95 duration-300">
...
<?php echo $__env->make('client_site.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ott-mia\ott-mia-mobile-tv-web\resources\views/client_site/pages/home.blade.php ENDPATH**/ ?>