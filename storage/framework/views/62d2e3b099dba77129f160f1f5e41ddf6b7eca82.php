...
<section class="py-[50px] flex flex-col sm:flex-row justify-between gap-5 items-start p-5">
    <div class="bg-black border border-cardborder p-5 w-full sm:w-2/12 ">
        <ul class="flex flex-col gap-7">
            <li><a href="" class="flex justify-start gap-4 text-white items-center text-lg"><img class="h-[38px] w-[38px]" src="<?php echo e(URL::asset('assets/frontend/images/account-logo.svg')); ?>" alt="">Account</a></li>
            <li><a href="" class="flex justify-start gap-4 text-white items-center text-lg"><img class="h-[38px] w-[38px]" src="<?php echo e(URL::asset('assets/frontend/images/subscription-logo.svg')); ?>" alt="">Subscription</a></li>
            <li><a href="" class="flex justify-start gap-4 text-white items-center text-lg"><img class="h-[38px] w-[38px]" src="<?php echo e(URL::asset('assets/frontend/images/device-logo.svg')); ?>" alt="">Devices</a></li>
            <li><a href="" class="flex justify-start gap-4 text-white items-center text-lg"><img class="h-[38px] w-[38px]" src="<?php echo e(URL::asset('assets/frontend/images/setting-logo.svg')); ?>" alt="">Devices</a></li>
            <li><a href="" class="flex justify-start gap-4 text-white items-center text-lg"><img class="h-[38px] w-[38px]" src="<?php echo e(URL::asset('assets/frontend/images/logout-logo.svg')); ?>" alt="">Devices</a></li>
        </ul>
    </div>
    <div class="bg-[#0F0F0F] border border-[#262626] p-10 w-full sm:w-9/12 ">
        ...
        <div class="flex flex-col gap-3 justify-start">
            ...
            <div class="rounded-full h-[200px] w-[200px]">
                <img class="w-full" src="<?php echo e(URL::asset('assets/frontend/images/profile-pic.png')); ?>" alt="">
            </div>
            <div>
...
<?php echo $__env->make('frontend.layouts.MainLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hadiuzzaman2\ott-mia-mobile-tv-web\resources\views/frontend/profile.blade.php ENDPATH**/ ?>