                ...
                <?php endif; ?>
                 ...
                 <?php echo Form::open(array('url' => array('admin/general_settings'),'class'=>'form-horizontal','name'=>'settings_form','id'=>'settings_form','role'=>'form','enctype' => 'multipart/form-data')); ?>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="footer_linkdin_link" value="<?php echo e(isset($settings->footer_linkdin_link) ? stripslashes($settings->footer_linkdin_link) : null); ?>" class="form-control">
                    </div>
                  </div>
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ott-mia\ott-mia-mobile-tv-web\resources\views/admin/pages/general_settings.blade.php ENDPATH**/ ?>