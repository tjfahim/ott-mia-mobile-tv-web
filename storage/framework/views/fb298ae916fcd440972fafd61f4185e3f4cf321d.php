              ...
              <div class="card-box">
                ...
                <?php endif; ?>
                 ...
                 <?php echo Form::open(array('url' => array('admin/series/add_edit_series'),'class'=>'form-horizontal','name'=>'series_form','id'=>'series_form','role'=>'form','enctype' => 'multipart/form-data')); ?>
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Series URL</label>
                    <div class="col-sm-8">
                      <input type="text" name="series_url" id="series_url" value="<?php echo e(isset($series_info->series_url) ? stripslashes($series_info->series_name) : null); ?>" class="form-control">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="duration" id="duration" value="<?php echo e(isset($series_info->duration) ? stripslashes($series_info->duration) : null); ?>" class="form-control">
                    </div>
                  </div>
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hadiuzzaman2\ott-mia-mobile-tv-web\resources\views/admin/pages/addeditseries.blade.php ENDPATH**/ ?>