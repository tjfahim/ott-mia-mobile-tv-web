              ...
              <div class="card-box">
                ...
                <?php endif; ?>
                 ...
                 <?php echo Form::open(array('url' => array('admin/subscription_plan/add_edit_plan'),'class'=>'form-horizontal','name'=>'slider_form','id'=>'slider_form','role'=>'form','enctype' => 'multipart/form-data')); ?>  
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.plan_description')); ?>*</label>
                    <div class="col-sm-8">
                      <textarea type="text" name="description" value="<?php echo e(isset($plan_info->description) ? $plan_info->description : null); ?>" class="form-control">
                      </textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="finalprice" value="<?php echo e(isset($plan_info->finalprice) ? $plan_info->finalprice : null); ?>" class="form-control" placeholder="9.99">
                    </div>
                  </div>   
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hadiuzzaman2\ott-mia-mobile-tv-web\resources\views/admin/pages/addeditplan.blade.php ENDPATH**/ ?>