                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo e(trans('words.comments')); ?></th>
                                            <th><?php echo e(trans('words.comment_status')); ?></th>
                                      ...
                                      <?php endif; ?>
                                        <?php $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e($comment->reels->title); ?></td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?php echo e(url('admin/reels/add-reply/' . $comment->id)); ?>"
                                                    ...
                                                    <a href="<?php echo e(url('admin/reels/comment-delete/' . $comment->id)); ?>"
...
<?php echo $__env->make('admin.admin_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/netskytv/public_html/resources/views/admin/pages/commentslist.blade.php ENDPATH**/ ?>