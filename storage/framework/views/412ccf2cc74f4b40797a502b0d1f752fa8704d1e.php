...
<body class="font-manrope text-white relative">
                ...
                <div class="flex justify-between gap-3">
                    <div class="hidden sm:flex gap-1">
                        <div class="relative" x-data="{open: false}" @click.away="open = false">
                            <button @click="open = !open" class="p-3 bg-second_black rounded-full hover:scale-110 duration-300"><img src="<?php echo e(URL::asset('frontend/images/search-icon.svg')); ?>" alt=""></button>
                            <div
                                x-show="open"
                        ...
                        <button class="p-3 bg-second_black rounded-full hover:scale-110 duration-300"><img src="<?php echo e(URL::asset('frontend/images/notif-icon.svg')); ?>" alt=""></button>
                    </div>
    ...
    <div class="bg-first_black w-full ">
     ...
     <!-- login section start -->
    <div class="popup-login bg-first_black rounded-md  p-10 absolute top-[120px] left-1/2 transform -translate-x-1/2" >
        ...
        <button class="close-popup absolute top-3 right-3 p-3 hover:scale-90 duration-300 rounded-full bg-redcolor"><img src="./images/x.svg" alt=""></button>
    </div>
    <!-- login section end -->


    <!-- registation start  -->
    <div class="popup-register bg-first_black rounded-md  p-10 absolute top-[120px] left-1/2 transform -translate-x-1/2" >
    <section class=" ">
        <div class="text-center text-white space-y-5">
    ...
    <!-- faq ask question sidebar start  -->
     <div class="absolute top-0 h-screen right-0 w-1/3 bg-second_black faq-div px-10 py-20 ">
        <!-- close button  -->
    ...
    <div class="absolute top-0 h-screen right-0 w-1/3 bg-first_black faq-div px-10 py-20 ">
        <!-- close button  -->
        <button class="faq-close absolute top-3 left-3 p-2 hover:scale-90 duration-300 rounded-full bg-redcolor"><img src="./images/x.svg" alt=""></button>
...
<?php /**PATH C:\xampp\htdocs\hadiuzzaman2\ott-mia-mobile-tv-web\resources\views/client_site/layouts/guest.blade.php ENDPATH**/ ?>