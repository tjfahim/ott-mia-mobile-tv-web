              ...
              <div class="card-box">
                ...
                <?php endif; ?>
                 ...
                 <?php echo Form::open(array('url' => array('admin/home_section'),'class'=>'form-horizontal','name'=>'settings_form','id'=>'settings_form','role'=>'form','enctype' => 'multipart/form-data')); ?>  
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label"><?php echo e(trans('words.section_2_live')); ?>*</label>
                    <div class="col-sm-8">
                      <select name="section_live_now[]" class="select2 select2-multiple" multiple="multiple" multiple data-placeholder="Select Live...">
                                 <?php $__currentLoopData = $live_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $live_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <option value="<?php echo e($live_data->id); ?>" <?php if(in_array($live_data->id, explode(",",$home_settings->section_live_now))): ?> selected <?php endif; ?>><?php echo e($live_data->channel_name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <select name="section3_tranding_movie[]" class="select2 select2-multiple" multiple="multiple" multiple data-placeholder="Select Movies...">
                                 <?php $__currentLoopData = $movies_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movies_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <option value="<?php echo e($movies_data->id); ?>" <?php if(in_array($movies_data->id, explode(",",$home_settings->section3_tranding_movie))): ?> selected <?php endif; ?>><?php echo e($movies_data->video_title); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                    </div>
                  </div>
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hadiuzzaman2\ott-mia-mobile-tv-web\resources\views/admin/pages/home_section.blade.php ENDPATH**/ ?>