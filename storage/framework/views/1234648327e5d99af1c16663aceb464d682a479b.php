                    ...
                    <div class="">
                     ...
                     <div class="col">
                        ...
                        <div class="flex gap-2 opacity-75">
                            ...
                            <a class=" bg-second_black border border-third_black p-3 rounded hover:scale-90 duration-200" href="<?php echo e(getcong('footer_fb_link')); ?>"><img class="size-5" src="<?php echo e(URL::asset('frontend/images/facebook-Icon.svg')); ?>" alt=""></a>
                            <a class=" bg-second_black border border-third_black p-3 rounded hover:scale-90 duration-200" href="<?php echo e(getcong('footer_twitter_link')); ?>"><img class="size-5" src="<?php echo e(URL::asset('frontend/images/x-Icon.svg')); ?>" alt=""></a>
                            <a class=" bg-second_black border border-third_black p-3 rounded hover:scale-90 duration-200" href="<?php echo e(getcong('footer_linkdin_link')); ?>"><img class="size-5" src="<?php echo e(URL::asset('frontend/images/linkdin-icon.svg')); ?>" alt=""></a>
                        </div>
                    </div>
                    </div>
...
<!-- registation end  -->
    ...
    <div x-cloak x-show="feedback" @click.outside="feedback=false" class="fixed top-0 h-screen right-0 w-1/3 bg-first_black faq-div px-10 py-20 "
            x-data="{
                ...
                async submitFeedback(){
                    ...
                    try {
                        // Send the form data to the server
                        const response = await axios.post('<?php echo e(URL::to('feedback')); ?>', this.form, {
                            headers: {
                                'X-CSRF-TOKEN': this.csrfToken,
                                'Content-Type': 'application/json',
                                'Accept': 'application/json',
    ...
    >
        <!-- close button  -->
        <button @click="feedback=false" class="absolute top-3 left-3 p-2 hover:scale-90 duration-300 rounded-full bg-redcolor"><img src="<?php echo e(URL::asset('frontend/images/x.svg')); ?>" alt=""></button>
        <div class="flex flex-col h-full">
            <div>
                    ...
                    <div x-data="{ numbers: Array.from({ length: 5 }, (_, i) => i), rating: 0 }" class="flex items-center justify-evenly gap-2">
                        <template x-for="(number, index) in numbers" :key="number">
                                ...
                                <img
                                    ...
                                    src="<?php echo e(URL::asset('frontend/images/start-icon.svg')); ?>"
                                    alt=""
...
<?php /**PATH C:\xampp\htdocs\ott-mia\ott-mia-mobile-tv-web\resources\views/client_site/layouts/app.blade.php ENDPATH**/ ?>