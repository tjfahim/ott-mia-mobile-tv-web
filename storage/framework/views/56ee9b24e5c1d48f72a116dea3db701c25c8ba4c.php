...
<div class="wrapper">
    <div class="container">
        <?php $__currentLoopData = $reels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $reel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="section" data-index="<?php echo e($index); ?>">
                <h3 class="title-container">
                    <?php echo e($reel->title); ?>

                </h3>
                <video src="<?php echo e(asset($reel->video_url)); ?>" controls></video>

                <!-- Like, Comment, and Share Section -->
                <div class="interaction-container">
                <button class="like-button" data-reel-id="<?php echo e($reel->id); ?>" <?php echo e(Auth::check() ? '' : 'disabled'); ?>>
    <?php if($reel->isLikedByUser()): ?>
        <i class="fas fa-heart"></i>
    <?php else: ?>
        <i class="far fa-heart"></i>
    <?php endif; ?>
</button>
                    <span class="like-count"><?php echo e($reel->likes->count()); ?></span>

                    <button class="comment-button" data-reel-id="<?php echo e($reel->id); ?>">
    <i class="far fa-comment"></i>
</button>
                    <span class="comment-count"><?php echo e($reel->comments->count()); ?></span>

                    <button class="share-button" data-reel-id="<?php echo e($reel->id); ?>">
...
<div id="commentModal" class="modal">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            ...
            <button id="submitComment" class="submit-comment btn btn-primary"  <?php echo e(Auth::check() ? '' : 'disabled'); ?>>Submit</button>
        </div>
    </div>
</div>
...
<?php echo $__env->make('site_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/netskytv/public_html/resources/views/pages/reels_single.blade.php ENDPATH**/ ?>